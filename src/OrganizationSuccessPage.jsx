...
export const OrganizationSuccessPage = () => {
    ...
    React.useEffect(() => {
        const handleCallback = async () => {
            ...
            try {
                ...
                const clientId = import.meta.env.VITE_AUTH0_CLIENT_ID_PROMPT_ORG;
                const redirectUri = `${window.location.origin}/success/organization`;

                // Get PKCE verifier from sessionStorage
                const verifier = sessionStorage.getItem('pkce_verifier_organization');
                if (!verifier) {
                    throw new Error('PKCE verifier not found');
                }

                console.log('[OrganizationSuccess] Exchanging code for tokens');
                ...
                // Clean up
                sessionStorage.removeItem('pkce_verifier_organization');
                ...
                console.error('[OrganizationSuccess] Error:', err);
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
                    <div className="text-center mb-6">
                        ...
                        <h1 className="text-3xl font-bold text-gray-900 mb-2">Organization Prompt Login Successful!</h1>
                        <p className="text-gray-600">You've successfully authenticated using the "Prompt for Organization" flow</p>
                    </div>
