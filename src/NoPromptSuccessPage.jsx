...
export const NoPromptSuccessPage = () => {
    ...
    React.useEffect(() => {
        const handleCallback = async () => {
            ...
            try {
                ...
                const clientId = import.meta.env.VITE_AUTH0_CLIENT_ID_NO_PROMPT;
                const redirectUri = `${window.location.origin}/success/no-prompt`;

                // Get PKCE verifier from sessionStorage
                const verifier = sessionStorage.getItem('pkce_verifier_no-prompt');
                if (!verifier) {
                    throw new Error('PKCE verifier not found');
                }

                console.log('[NoPromptSuccess] Exchanging code for tokens');
                ...
                // Clean up
                sessionStorage.removeItem('pkce_verifier_no-prompt');
                ...
                console.error('[NoPromptSuccess] Error:', err);
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
                    <div className="text-center mb-6">
                        ...
                        <h1 className="text-3xl font-bold text-gray-900 mb-2">Direct Login Successful!</h1>
                        <p className="text-gray-600">You've successfully authenticated using the "No Prompt" flow</p>
                    </div>
