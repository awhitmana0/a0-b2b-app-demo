...
export const PromptCredentialsLogin = () => {
    ...
    useEffect(() => {
        if (shouldLogin && !isAuthenticated) {
            console.log('[PromptCredentialsLogin] Auto-triggering login');
            loginWithRedirect({
                authorizationParams: {}
            });
        }
    ...
    const handleLogin = async () => {
        // With "Prompt for Credentials" flow, Auth0 handles identifier-first
                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="bg-gray-50 p-8 rounded-xl border border-gray-200 text-center">
                        ...
                        <p className="mt-6 text-sm text-gray-500">
                            This flow uses Auth0's "Prompt for Credentials" setting, which implements identifier-first login.
                        </p>
                    </div>
                    ...
                    <div className="mt-8 p-6 bg-blue-50 border border-blue-200 rounded-lg">
                        ...
                        <ul className="text-sm text-blue-800 space-y-2">
                            <li>• You'll first be asked to enter your email or username</li>
                            <li>• Auth0 automatically determines your organization</li>
                            <li>• You'll then be prompted for your password or redirected to SSO</li>
                            <li>• No manual organization selection needed</li>
                        </ul>
                    </div>
                </div>
            </main>
